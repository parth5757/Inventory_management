...
class Users(AbstractUser):
    ...
    role = models.CharField(max_length=50, blank=True, null=True, default='Admin', choices=(('Admin', 'Admin'), ('User', 'User'), ('Customer', 'Customer'), ('Staff', 'Staff'), ('Manager', 'Manager'), ('Super Admin', 'Super Admin')))
...
class Modules(models.Model):
    ...
    module_description = models.CharField(null=True, blank=True, max_length=50)
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now=True)
